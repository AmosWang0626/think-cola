 ...
 * @date modify by amos.wang 2019/07/20
 */
...
//	}
    ...
    private org.hibernate.cfg.AccessType determineLocalClassDefinedAccessStrategy() {
        ...
        org.hibernate.annotations.AttributeAccessor accessType = xClass.getAnnotation(org.hibernate.annotations.AttributeAccessor.class);
        if (accessType != null) {
